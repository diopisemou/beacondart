...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new africa.ejara.beacondart.BeacondartPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin beacondart_android, africa.ejara.beacondart.BeacondartPlugin", e);
    }
    try {
